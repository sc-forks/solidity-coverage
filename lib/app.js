...
class App {
  ...
  */
   ...
   * @param  {Boolean} dontKillProcess should keep the process running
   */
  generateReport(dontKillProcess) {
        ...
        .on('close', () => {
          ...
          try {
            ...
            reporter.write(collector, true, () => {
              ...
              this.cleanUp(undefined, dontKillProcess);
              resolve();
            });
          } catch (err) {
